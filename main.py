...
from model_trainer import VSDF
...
def single_run():
	...
	ckpt_dir = os.path.join(ROOT_DIR, f'results/ckpt')
	log_dir = os.path.join(ROOT_DIR, f'results/log')

	os.makedirs(ckpt_dir, exist_ok=True)
	os.makedirs(log_dir, exist_ok=True)

	# Data：judge if it needs test process.
